   ...
   <div class="spinner mx-auto" v-if="doneLoading === 'false'"></div>
    <main class="mx-auto" v-if="doneLoading === 'OK'">
      ...
      <div class="currently text-left">
        ...
        <span class="mr-3 text-red-lighter font-bold">↑{{ wheather.daily.data[0].temperatureMax.toFixed(0) }}&deg;C</span>
        <span class="font-bold text-blue-lighter">↓{{ wheather.daily.data[0].temperatureMin.toFixed(0) }}&deg;C</span>
      </div>
        ...
        <div class="dailyWeather mt-10">
          ...
          <div class="mx-5" v-for="(day, index) in wheather.daily.data.slice(1)" :key="day.index">
              ...
              <p class="font-bold text-red-lighter">↑{{ day.temperatureMax.toFixed(0) }}&deg;C</p>
              <p class="font-bold text-blue-lighter">↓{{ day.temperatureMin.toFixed(0) }}&deg;C</p>
