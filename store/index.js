            ...
            function displayLocationInfo() {
              navigator.geolocation.getCurrentPosition(location => {
                ...
                axios
                  .all([
                    axios.get(
                      `${CORS}https://api.darksky.net/forecast/${KEY}/${latitude},${longitude}?lang=sv&units=auto&exclude="flags,alerts,offset,minutely"`
                    ),
                    axios.get(
                      `https://maps.googleapis.com/maps/api/geocode/json?latlng=${latitude},${longitude}&key=AIzaSyBLilWwDtdymiAABzXQzt_AZ-_fiBRrrbw`
                    )
                  ])
                  .then(
                    axios.spread(
